...
class MenuItemSeeder extends Seeder
{
    public function run(): void
    {
        ...
        MenuItem::create(['category_id'=>$starters->id,'name'=>'Veg Manchurian','description'=>'Veg balls','price'=>200, 'image'=>$getImage('Starters'), 'is_special'=>false, 'is_recommended'=>true, 'is_top_selling'=>false]);
        MenuItem::create(['category_id'=>$starters->id,'name'=>'Tandoori Chicken','description'=>'Clay oven chicken','price'=>320, 'image'=>$getImage('Starters'), 'is_special'=>true, 'is_recommended'=>false, 'is_top_selling'=>true]);
        ...
        /* ---------- Fast Food ---------- */
        MenuItem::create(['category_id'=>$fastFood->id,'name'=>'Veg Burger','description'=>'Veg patty burger','price'=>120, 'image'=>$getImage('Fast Food'), 'is_special'=>true, 'is_recommended'=>true, 'is_top_selling'=>true]);
        MenuItem::create(['category_id'=>$fastFood->id,'name'=>'Chicken Burger','description'=>'Chicken patty','price'=>150, 'image'=>$getImage('Fast Food'), 'is_top_selling'=>true]);
        MenuItem::create(['category_id'=>$fastFood->id,'name'=>'Paneer Sandwich','description'=>'Grilled sandwich','price'=>140, 'image'=>$getImage('Fast Food'), 'is_recommended'=>true]);
        ...
        /* ---------- Main Course ---------- */
        MenuItem::create(['category_id'=>$mainCourse->id,'name'=>'Paneer Butter Masala','description'=>'Creamy paneer','price'=>300, 'image'=>$getImage('Main Course'), 'is_special'=>true, 'is_recommended'=>true, 'is_top_selling'=>true]);
        MenuItem::create(['category_id'=>$mainCourse->id,'name'=>'Shahi Paneer','description'=>'Rich curry','price'=>320, 'image'=>$getImage('Main Course')]);
        MenuItem::create(['category_id'=>$mainCourse->id,'name'=>'Dal Makhani','description'=>'Slow cooked dal','price'=>260, 'image'=>$getImage('Main Course'), 'is_recommended'=>true]);
        MenuItem::create(['category_id'=>$mainCourse->id,'name'=>'Butter Chicken','description'=>'Buttery chicken','price'=>340, 'image'=>$getImage('Main Course'), 'is_special'=>true, 'is_top_selling'=>true]);
        ...
        /* ---------- Breads ---------- */
        MenuItem::create(['category_id'=>$breads->id,'name'=>'Tandoori Roti','description'=>'Wheat roti','price'=>25, 'image'=>$getImage('Breads'), 'is_top_selling'=>true]);
        MenuItem::create(['category_id'=>$breads->id,'name'=>'Butter Naan','description'=>'Butter naan','price'=>40, 'image'=>$getImage('Breads'), 'is_top_selling'=>true]);
        MenuItem::create(['category_id'=>$breads->id,'name'=>'Garlic Naan','description'=>'Garlic naan','price'=>50, 'image'=>$getImage('Breads'), 'is_recommended'=>true]);
        ...
        MenuItem::create(['category_id'=>$rice->id,'name'=>'Veg Biryani','description'=>'Veg biryani','price'=>240, 'image'=>$getImage('Rice & Biryani'), 'is_special'=>true, 'is_recommended'=>true]);
        MenuItem::create(['category_id'=>$rice->id,'name'=>'Chicken Biryani','description'=>'Chicken biryani','price'=>280, 'image'=>$getImage('Rice & Biryani'), 'is_top_selling'=>true]);
        MenuItem::create(['category_id'=>$rice->id,'name'=>'Mutton Biryani','description'=>'Mutton biryani','price'=>360, 'image'=>$getImage('Rice & Biryani'), 'is_special'=>true, 'is_top_selling'=>true]);

        /* ---------- Drinks ---------- */
        MenuItem::create(['category_id'=>$drinks->id,'name'=>'Sweet Lassi','description'=>'Yogurt drink','price'=>90, 'image'=>$getImage('Drinks'), 'is_top_selling'=>true]);
        MenuItem::create(['category_id'=>$drinks->id,'name'=>'Salted Lassi','description'=>'Salty lassi','price'=>90, 'image'=>$getImage('Drinks')]);
        MenuItem::create(['category_id'=>$drinks->id,'name'=>'Cold Drink','description'=>'Soft drink','price'=>60, 'image'=>$getImage('Drinks'), 'is_top_selling'=>true]);
        ...
        /* ---------- Desserts ---------- */
        MenuItem::create(['category_id'=>$desserts->id,'name'=>'Gulab Jamun','description'=>'Sweet balls','price'=>100, 'image'=>$getImage('Desserts'), 'is_special'=>true, 'is_top_selling'=>true]);
        MenuItem::create(['category_id'=>$desserts->id,'name'=>'Rasgulla','description'=>'Spongy sweet','price'=>90, 'image'=>$getImage('Desserts'), 'is_recommended'=>true]);
        MenuItem::create(['category_id'=>$desserts->id,'name'=>'Jalebi','description'=>'Crispy sweet','price'=>80, 'image'=>$getImage('Desserts')]);
